...
<div class="row d-flex justify-content-center">
	<div class="col-sm-10">
		<form class="text-center" id="checkNumberStatus-form" method="post" enctype="multipart/form-data"
			action="javascript:void(0)">
			<div class="card border-secondary mb-3">
				...
				<div class="card-footer text-muted text-center">
					<button type="submit" name="checkNumberStatus" id="checkNumberStatus"
